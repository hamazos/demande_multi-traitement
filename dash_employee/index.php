  ...
  <?php
  session_start();
  if((isset($_SESSION['logemployee']) && $_SESSION['logemployee']==true))
  {
  
  include('includesemployee/header.php');
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            ...
            >
              ...
              <a class="dropdown-item" href="#">hi :) <?php print_r("employee " . $_SESSION['username']);?></a>
    ...
    <div class="wrapper d-flex">
      <div class="sideMenu bg-mattBlackLight">
        <div class="sidebar">
          <ul class="navbar-nav">
            <li class="nav-item">
            <a href="?page=Departements" class="nav-link px-2">
 ...
 <?php
 include('includesemployee/footer.php');
}
else{
  include('login.php');
}
